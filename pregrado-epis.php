			...
			<section class="wrapper style1">
				<div class="container">
					<div class="row">
						...
						<section class="6u">
							<div class="box post">
								<a href="documentos/Plan de estudios - Sistemas.pdf" class="image left" target="_new"><img src="images/plan estudios sistemas.png" alt="" /></a>
								<div class="inner">
									<h3>Plan de estudios</h3>
									<p>Los cursos ha llevar a lo largo de la carrera universitaria seran ....</p>
									<a href="documentos/Plan de estudios - Sistemas.pdf" download="Plan de estudios - Sistemas.pdf">Descargar</a>
								</div>
							</div>
						</section>
